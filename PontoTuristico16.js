...
export function PontoTuristico16({ navigation }) {
    return (
        <LinearGradient
            ...
            <View style={styles.container}>
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    <View style={styles.content}>
                        ...
                        <Text style={styles.description}>
                        Torneios e festivais de pesca são realizados no local frequentemente, além de outros eventos, são realizados anualmente nas épocas específicas do ano.
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                "https://maps.app.goo.gl/q4mPRpoGQ1j44qiU7"
                                )
                            }
                            >
...
export default PontoTuristico16;
