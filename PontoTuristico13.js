...
export function PontoTuristico13({ navigation }) {
    return (
        <LinearGradient
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    <View style={styles.content}>
                        ...
                        <View style={styles.imageContainer}>
                            <Image source={require('./assets/imagens/PontosIacanga/centrocultural1.jpg')} style={styles.imageLarge} resizeMode="cover" />
                        </View>
