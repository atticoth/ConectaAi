                ...
                <View style={styles.imageContainer}>
                    <View style={styles.imageColumn}>
                        <TouchableOpacity onPress={() => handleImagePress('imagem1')}>
                            <Image
                                source={require('./assets/imagens/galeria/fabrica/fabricadecultura2.jpg')}
                                style={styles.image}
                                resizeMode="cover"
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => handleImagePress('imagem2')}>
                            <Image
                                source={require('./assets/imagens/galeria/parque/parqueecologico.jpg')}
                                style={styles.image}
                                resizeMode="cover"
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => handleImagePress('imagem3')}>
                            <Image
                            source={require('./assets/imagens/galeria/circoescola/circoescola.jpg')}
                                style={styles.image}
                                resizeMode="cover"
                            />
                        </TouchableOpacity>
                    ...
                    <View style={styles.imageColumn}>
                        <TouchableOpacity onPress={() => handleImagePress('imagem4')}>
                            <Image
                                source={require('./assets/imagens/galeria/jardim/jardimbotanico4.jpg')}
                                style={styles.image}
                                resizeMode="cover"
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => handleImagePress('imagem5')}>
                            <Image
                                source={require('./assets/imagens/galeria/estadio/estadio2.jpg')}
                                style={styles.image}
                                resizeMode="cover"
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => handleImagePress('imagem6')}>
                            <Image
                                source={require('./assets/imagens/galeria/praca/Pracadamoca.jpg')}
                                style={styles.image}
                                resizeMode="cover"
                            />
                        </TouchableOpacity>
